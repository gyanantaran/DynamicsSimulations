...
The code for this in file [./Ballistics/src/Ballistics.jl](./Ballistics/src/Ballistics.jl):
...
![Increasing intial velocities](../media/problem09/initial_velocity_change.png)
...
Doing this numerically, in file [./Ballistics/src/Benchmarks.jl](./Ballistics/src/Ballistics.jl):
...
Let us plot the relation of drag with the best angle for a high velocity (say v = 1200), in file [./Ballistics/src/Ballistics.jl](./Ballistics/src/Ballistics.jl):
...
There isn't much change in the eventual best angle for large velocities as drag changes. The best angle in such case is some constant close to zero. I will explore this more later. The plot generated by above code is:
