...
2. Make sure you thoroughly understand these sections of the Ruina/Pratap pdf book, available from Ruina’s www page:  
   - Chapter 1 (read),
   - Chapter 2 (skim, only study things you don’t know well already, make sure that within a few weeks you know all of this well. ),
   - Chapter 3,
   - Section 17.1,
   - Appendix A.
3. Write the following, if true, if not write that which is true:
