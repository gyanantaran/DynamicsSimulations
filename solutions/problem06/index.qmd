...
2. Assume all parameters and IC’s above are given.  
    i. Plot the trajectory of the mass.  
    ii. Animate the trajectory of the mass.  
3. How many ways can you think of checking the numerical solution, find as manyas you can, and do the check. The list is started here:
